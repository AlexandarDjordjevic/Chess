...
class Bishop_movement_tests : public testing::Test {
...
TEST_F(Bishop_movement_tests, ilegal_diagonal_move) {
...
TEST_F(Bishop_movement_tests, ilegal_horizontal_move) {
    board[{"a1"}] = chess::Piece_factory::create(chess::Piece_type::bishop, chess::Color::white);
    ASSERT_THROW(board.move_piece({"a1:e1", chess::Color::white}), chess::exceptions::Invalid_move);
    ASSERT_NE(board[{"a1"}], nullptr);
}

TEST_F(Bishop_movement_tests, ilegal_vertical_move) {
    board[{"a1"}] = chess::Piece_factory::create(chess::Piece_type::bishop, chess::Color::white);
    ASSERT_THROW(board.move_piece({"a1:a7", chess::Color::white}), chess::exceptions::Invalid_move);
    ASSERT_NE(board[{"a1"}], nullptr);
}

TEST_F(Bishop_movement_tests, valid_diagonal_move_rising_x_rising_y) {
    board[{"a1"}] = chess::Piece_factory::create(chess::Piece_type::bishop, chess::Color::white);
...
TEST_F(Bishop_movement_tests, valid_diagonal_move_falling_x_faling_y) {
...
TEST_F(Bishop_movement_tests, valid_diagonal_move_rising_x_faling_y) {
...
TEST_F(Bishop_movement_tests, valid_diagonal_move_falling_x_rising_y) {
...
TEST_F(Bishop_movement_tests, diagonal_move_with_enemy_figure_between_start_and_end) {
    board[{"a1"}] = chess::Piece_factory::create(chess::Piece_type::bishop, chess::Color::white);
...
TEST_F(Bishop_movement_tests, diagonal_move_with_ally_figure_between_start_and_end) {
    board[{"a1"}] = chess::Piece_factory::create(chess::Piece_type::bishop, chess::Color::white);
...
TEST_F(Bishop_movement_tests, diagonal_move_destination_occupied_with_ally_figure) {
    board[{"a1"}] = chess::Piece_factory::create(chess::Piece_type::bishop, chess::Color::white);
    ASSERT_THROW(board.move_piece({"a1:c7", chess::Color::white}), chess::exceptions::Invalid_move);
    ASSERT_NE(board[{"a1"}], nullptr);
}
...
TEST_F(Bishop_movement_tests, diagonal_move_kill_enemy_figure) {
    board[{"a1"}] = chess::Piece_factory::create(chess::Piece_type::bishop, chess::Color::white);
    ASSERT_THROW(board.move_piece({"a1:c7", chess::Color::white}), chess::exceptions::Invalid_move);
    ASSERT_NE(board[{"a1"}], nullptr);
}